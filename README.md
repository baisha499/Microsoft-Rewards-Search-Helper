...
```cmd
git clone https://github.com/baisha499/Microsoft-Rewards-Search-Helper
```
...
# 这个程序中的搜索5次为会员，15次为银牌，20次为金牌，当然你可以自定义
...
[chorme驱动最新版（官网提供）](https://googlechromelabs.github.io/chrome-for-testing/)
